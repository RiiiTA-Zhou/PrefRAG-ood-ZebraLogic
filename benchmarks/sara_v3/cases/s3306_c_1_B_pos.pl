...
citizenship_(span("citizen",135,141)).
american_employer_(span("American employer",156,172)).
agent_(span("American employer",156,172),span("Alice",144,148)).
agent_(span("citizen",135,141),span("Bob",116,118)).
patient_(span("citizen",135,141),span("American",126,133)).
